...
return {
    { -- LSP Configuration & Plugins
      ...
      config = function()
        ...
        -- Mason cannot install r_language_server, so we configure it manually
        -- Requires: R installed and the languageserver package (install.packages("languageserver"))
        lspconfig.r_language_server.setup({
            ...
            root_dir = function(fname)
                return lsputil.root_pattern('.git', '_quarto.yml', '.Rproj.user')(fname)
                    ...
                    or vim.fn.fnamemodify(fname, ':p:h')  -- fallback to file's directory
            end,
            settings = {
                r = {
                    lsp = {
