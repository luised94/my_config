...
1. **Install Zig**:
```bash
wget https://ziglang.org/builds/zig-linux-x86_64-0.14.0-dev.3187+d4c85079c.tar.xz
...
# Verify command
zig version
# Should display zig-linux-x86_64-0.14.0-dev.3187+d4c85079c
...
wget https://builds.zigtools.org/zls-linux-x86_64-0.14.0-dev.390+188a4c0.tar.xz

# Extract the archive:
tar -xf zls-linux-x86_64-0.14.0-dev.390+188a4c0.tar.xz
